...
CGFloat const COLLECTION_VIEW_HEIGHT = 35.0;
static CGFloat const TAGCOLLECTION_CELL_HEIGHT = 35.0;
...
@interface PARTagPickerViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, PARBackspaceTextFieldDelegate, PARTextFieldCollectionViewCellDelegate, PARTextFieldCollectionViewCellDelegate>
